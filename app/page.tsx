...
import Link from "next/link"
import { BookOpen, Trophy, Zap, Cpu } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <Link href="/quiz/unit1">
              <Button size="lg" className="text-lg px-6 py-3">
                Unit 1
              </Button>
            </Link>
            <Link href="/quiz/unit2">
              <Button size="lg" className="text-lg px-6 py-3">
                Unit 2
              </Button>
            </Link>
            <Link href="/quiz/unit3">
              <Button size="lg" className="text-lg px-6 py-3">
                Unit 3
              </Button>
            </Link>
            <Link href="/quiz/unit4">
              <Button size="lg" className="text-lg px-6 py-3">
                Unit 4
              </Button>
            </Link>
            <Link href="/quiz/8051">
              <Button size="lg" className="text-lg px-6 py-3 bg-blue-700 hover:bg-blue-800">
                8051
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              ...
              <div className="grid grid-cols-3 gap-2">
                <Link href="/quiz/unit1">
                  <Button className="w-full text-sm" size="sm">Unit 1</Button>
                </Link>
                <Link href="/quiz/unit2">
                  <Button className="w-full text-sm" size="sm">Unit 2</Button>
                </Link>
                <Link href="/quiz/unit3">
                  <Button className="w-full text-sm" size="sm">Unit 3</Button>
                </Link>
                <Link href="/quiz/unit4">
                  <Button className="w-full text-sm" size="sm">Unit 4</Button>
                </Link>
                <Link href="/quiz/8051" className="col-span-2">
                  <Button className="w-full text-sm" size="sm">8051 Topics</Button>
                </Link>
              </div>
            </CardContent>
          </Card>
